...
/**
 * Configuration class for WebSocket and STOMP messaging in the Dashboard Backend.
 * Enables the message broker and registers STOMP endpoints to support real-time 
 * market data updates for the frontend.
 */
@Configuration
